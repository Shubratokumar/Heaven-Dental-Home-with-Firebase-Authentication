    ...
    <div>
        ...
        <h2 className='fs-1 text-center q-title'>Question and Answer :</h2>
            ...
            <div className="col-sm-12 col-lg-4">
                ...
                <hr />                
                <div className="fs-5 fst-italic justified"><span className='answer'>Answer :  </span>
                <p>Basically i'm using Firebase for authentication. Firebase is Google’s  application development platform. It has a lot of different products that cover much of what’s needed to build mobile, web app. Firebase can be used when you do not want to spend a lot of time developing your own backend. It can be used for rapid development. I have been using it in my apps in production. You will not have to take care of servers, etc, Google will take care of it for you.</p>
                <br />
                <p>I may implement following technologies as an alternative of Firebase authentication. </p>
                <ul>
                    <li>Auth0</li>
                    <li>MongoDB</li>
                    <li>Passport</li>
            ...
            <div className="col-sm-12 col-lg-4">
                <div className="shadow p-3 mb-5 bg-body rounded">
                <h4 className='fs-3'>Q - 03: What other services does firebase provide other than authentication?</h4>
                <hr />
                <div className="fs-5 fst-italic justified"><span className='answer'>Answer :  </span>
                ...
                <p>There are many services which Firebase provides, Most useful of them are as followings:</p>
                <ul>
